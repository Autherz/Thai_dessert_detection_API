...
class Predict:
    ...
    def predict(self,
        ...
        weights_path = 'ssd_keras/ssd300_pascal_Thai_D_8_epoch-50_loss-3.2468_val_loss-2.6587.h5'
        ...
        classes = ['background', 'Foi_Tong', 'grilled_sticky_rice', 'kanomkrok', 'kanom_tan', 'thai_mango_sticky_rice',
                   'Thong_yib', 'Thong_yod']
        ...
        generate_pre = Predict(image=self.images, image_path=self.image_path)
